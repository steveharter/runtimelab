    ...
    public partial class JsonContext : JsonSerializerContext
    {
        ...
        private class LocationTypeInfo
        {
            ...
            private void SerializeFunc(Utf8JsonWriter writer, object value, ref WriteStack writeStack, JsonSerializerOptions options)
            {
                ...
                _property_Address1.WriteValue(obj.Address1, writer);
                _property_Address2.WriteValue(obj.Address2, writer);
                _property_City.WriteValue(obj.City, writer);
                _property_State.WriteValue(obj.State, writer);
                _property_PostalCode.WriteValue(obj.PostalCode, writer);
                _property_Name.WriteValue(obj.Name, writer);
                _property_PhoneNumber.WriteValue(obj.PhoneNumber, writer);
                _property_Country.WriteValue(obj.Country, writer);
            }
