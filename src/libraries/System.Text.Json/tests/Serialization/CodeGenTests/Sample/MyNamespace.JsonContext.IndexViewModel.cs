    ...
    public partial class JsonContext : JsonSerializerContext
    {
        ...
        private class IndexViewModelTypeInfo
        {
            ...
            public IndexViewModelTypeInfo(JsonContext context)
            {
                ...
                _property_ActiveOrUpcomingEvents = typeInfo.AddProperty(nameof(MyNamespace.IndexViewModel.ActiveOrUpcomingEvents),
                ...
                //_property_FeaturedCampaign = typeInfo.AddProperty(nameof(MyNamespace.IndexViewModel.FeaturedCampaign),
                //    (obj) => { return ((IndexViewModel)obj).FeaturedCampaign; },
                //    (obj, value) => { ((IndexViewModel)obj).FeaturedCampaign = value; },
                //    context.CompaignSummaryViewModel);

                _property_IsNewAccount = typeInfo.AddProperty(nameof(MyNamespace.IndexViewModel.IsNewAccount),
            ...
            private void SerializeFunc(Utf8JsonWriter writer, object value, ref WriteStack writeStack, JsonSerializerOptions options)
            {
                ...
                _property_ActiveOrUpcomingEvents.WriteObject(obj.ActiveOrUpcomingEvents, ref writeStack, writer);
                //_property_FeaturedCampaign.WriteValue(obj.FeaturedCampaign, writer);
                _property_IsNewAccount.WriteValue(obj.IsNewAccount, writer);
            }
            ...
            private IndexViewModel DeserializeFunc(ref Utf8JsonReader reader, ref ReadStack readStack, JsonSerializerOptions options)
            {
                ...
                {
                    reader.Read();
                    _property_ActiveOrUpcomingEvents.ReadValueAndSetMember(ref reader, ref readStack, obj);
                    if (!ReadPropertyName(ref reader)) goto Done;
                    propertyName = reader.ValueSpan;
                }
                ...
                //{
                //    reader.Read();
                //    _property_FeaturedCampaign.ReadValueAndSetMember(ref reader, ref readStack, obj);
                //    if (!ReadPropertyName(ref reader)) goto Done;
                //    propertyName = reader.ValueSpan;
                //}
